  ...
  return (
      <View className="flex-1 bg-white">
          <Appbar.Header className="bg-white flex-row items-center justify-between shadow-md px-2">
            ...
            {/* Center: Title */}
            <Appbar.Content title="Foodbanks" titleStyle={{ fontSize: 18, fontWeight: 'bold', textAlign: 'center' }} />
          ...
          <View className = "items-center">
              <View className="flex-row items-center bg-[#e7e7e7] rounded-3xl px-6 mx-5 mt-5 mb-7 h-[50px] shadow-md">
              ...
              <Text className= "font-bold text-2xl mb-5" >Foodbanks near your Location</Text>
